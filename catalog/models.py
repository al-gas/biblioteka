...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=1000, help_text="Краткое описание книги.", verbose_name="Описание")
    isbn = models.CharField('ISBN', max_length=13,
                            help_text='13 Character <a href="https://www.isbn-international.org/content/what-isbn'
                                      '">ISBN number</a>')
    genre = models.ManyToManyField(Genre, help_text="Выбирете жанр", verbose_name="Жанр")
...
class Borrower(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the url to access a particular borrower instance."""
        return reverse('borrower-detail', args=[str(self.id)])

    def __str__(self):
        """String for representing the Model object."""
        return '{0}, {1}, {2}'.format(self.last_name, self.first_name, self.patronomic_name)
